...
export const attack: Attack = {
  ...
  description: 'Resolves multiple plaintexts when gcd(e, phi(n)) > 1 using known p and q factors. Requires p and q as inputs (use factorization attacks first). Use after factoring n, when public exponent shares a factor with phi(n).',
  inputs: [
...
\\\\textbf{References:} Williams, 1980; May, "Attacks on RSA with Small Parameters," 2003\`,
  ...
  priority: 'low',
  applicableCheck: rsaNeeds.nECPQ,
};
